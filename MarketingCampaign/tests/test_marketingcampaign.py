...
# Use importlib so the module is loaded as 'marketing_app' and does not
...
_spec = importlib.util.spec_from_file_location("marketing_app", _app_path)
app = importlib.util.module_from_spec(_spec)
sys.modules["marketing_app"] = app
